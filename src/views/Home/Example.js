...
export default function Example() {
    ...
    useEffect(() => {
        const obj = { authenticate_key: "abcd123XYZ" };
        postRecord(APIGetExampleData, obj)
            .then(res => {
                if (res.data[0].response.status === "success") {
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="features_sec_right_2">
                                            {Object.keys(exampleData).length > 0 ? (
                                                <img src={exampleData.banner_underneath_sec.image} alt="" title="" />
                                            ) : (
                                                <Skeleton variant="text" width={400} height={300} style={{ background: "#bbbbbb", margin: "0 auto" }} />
                                            )}
                                        ...
                                        <div class="features_sec_left">
                                            <h4>
                                                {Object.keys(exampleData).length > 0 ? (
                                                    ...
                                                    <Skeleton variant="text" width={500} height={80} style={{ background: "#bbbbbb", margin: "0 auto" }} />
                                                )}
                                            </h4>
                                            <p>
                                                {Object.keys(exampleData).length > 0 ? (
                                                    ...
                                                    <Skeleton variant="text" width={500} height={180} style={{ background: "#bbbbbb", margin: "0 auto" }} />
                                                )}
                                            </p>
                                            {Object.keys(exampleData).length > 0 ? (
                                                <div
                                                ...
                                                <Skeleton variant="text" width={500} height={200} style={{ background: "#bbbbbb", margin: "0 auto" }} />
                                            )}
                            ...
                            {Object.keys(exampleData).length > 0 ? (
                                ...
                                <div>
                                    <div class="col-lg-4 col-md-4" style={{ float: "left" }}>
                                        <Skeleton variant="text" width={330} height={280} style={{ background: "#bbbbbb", margin: "0 auto" }} />
                                    </div>
                                    <div class="col-lg-4 col-md-4" style={{ float: "left" }}>
                                        <Skeleton variant="text" width={330} height={280} style={{ background: "#bbbbbb", margin: "0 auto" }} />
                                    </div>
