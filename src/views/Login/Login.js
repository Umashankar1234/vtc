                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="input-block"><i class="icon far fa-envelope"></i>
                                                            <input type="text" id="input-text2" required spellcheck="false" onChange={handleInputchange} name="username" value={user.username} />
                                                    ...
                                                    <li>
                                                        <div class="input-block">
                                                            <input type={user.showPassword ? "text" : "password"} id="input-text" required spellcheck="false" onChange={handleInputchange} name="password" value={user.password} />
                                                    ...
                                                    <li>
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <a onClick={() => { goToregister() }} class="login-forgotpassword red" style={{ cursor: "pointer" }}>New Agent ? Click here to register</a>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <a onClick={() => { setOpenModal(true) }} class="login-forgotpassword red" style={{ cursor: "pointer" }}>Forgot Password?</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="row align-items-center">
                                                            <div class="col-md-12">
                                                                <button type="submit" class="have_pics login_btn_new">Login<i class="fas fa-arrow-right"></i>
                                                                </button>
