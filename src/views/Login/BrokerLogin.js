                                            ...
                                            <div class="login-box-right">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ReCAPTCHA
                                                            sitekey="6Lc8HPAhAAAAAIBxTXqsqAly0VNWzJSgYRmr8C-I"
                                                            onChange={onChange}
                                                        />
                                                    </li>
                                                    <li>
                                                        <div class="row align-items-center">
                                                            <div class="col-md-7">
                                                                <button type="submit" class="have_pics login_btn_new">Login<i class="fas fa-arrow-right"></i></button>
                                                            ...
                                                            <div class="col-md-5 text-right"><a onClick={() => { setOpenModal(true) }} class="login-forgotpassword red" >Forgot Password?</a></div>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
