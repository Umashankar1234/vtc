    ...
    return (
        <Router history={hist}>
            <Switch>
                ...
                <PrivateRoute path={APIPath() + "edit-floor-plan/:tourid?"} component={EditFloorPlan} />
                <PrivateRoute path={APIPath() + "view-floor-plans/:tourid?"} component={AgentFloorPlan} />
                <PrivateRoute path={APIPath() + "site/trafficreport/:tourid?"} component={TrafficReport} />
                <PrivateRoute path={APIPath() + "agent-pending-order-list"} component={AgentPendingOrderList} />
                <PrivateRoute path={APIPath() + "agent-order-list"} component={AgentOrderList} />
                <PrivateRoute path={APIPath() + "agent-slide-show/:tourid?"} component={AgentSlideShow} />
                <PrivateRoute path={APIPath() + "agent-edit-video/:tourid?"} component={AgentEditVideo} />
                <PrivateRoute path={APIPath() + "agent-edit-flyer/:flyerid?"} component={AgentEditFlyer} />
                <PrivateRoute path={APIPath() + "agent-edit-tour/:tourid?"} component={AgentEditTour} />
                <PrivateRoute path={APIPath() + "agent-tour-list"} component={AgentTourList} />
                <PrivateRoute path={APIPath() + "edit-image-set/:imagesetid?"} component={EditImageSet} />
                <PrivateRoute path={APIPath() + "agent-privacy"} component={AgentPrivacy} />
                <PrivateRoute path={APIPath() + "agent-panaroma/:tourid?"} component={AgentPanaroma} />
                <PrivateRoute path={APIPath() + "agent-support"} component={AgentSupport} />
                <PrivateRoute path={APIPath() + "agent-preferred-vendor"} component={AgentPrefferedVendor} />
                <PrivateRoute path={APIPath() + "agent-flyer"} component={AgentFlyerList} />
                <PrivateRoute path={APIPath() + "agent-first-tour"} component={AgentFirstTour} />
                <PrivateRoute path={APIPath() + "agent-setting/:company?"} component={AgentSetting} />
                <PrivateRoute path={APIPath() + "broker-setting"} component={BrokerSetting} />
                <PrivateRoute path={APIPath() + "agent-image-sets"} component={AgentImageSets} />
                <PrivateRoute path={APIPath() + "agent-video-list"} component={AgentVideoList} />
                ...
                <PrivateRoute path={APIPath() + "broker-edit-agent/:agentid?"} component={BrokerEditAgent} />
                <PrivateRoute path={APIPath() + "agent-view-flyer/:flyerid?"} component={AgentViewFlyer} />
                <PrivateRoute path={APIPath() + "my-cafe-gellary/:agentId"} component={MyCafeGellary} />
                <PrivateRoute exact path={APIPath() + "agent-view-flyer-active/:flyerid?"} component={AgentViewFlyerActive} />
                <PrivateRoute exact path={APIPath() + "agent-download-flyer/:flyerid?"} component={AgentDownloadFlyer} />
                <PrivateRoute path={APIPath() + "agent-video-selected/:videoid/:agentid?"} component={AgentVideoSelected} />
                <PrivateRoute path={APIPath() + "agent-ezflash-card/:flashid?"} component={AgentEzFlashCard} />
                <PrivateRoute path={APIPath() + "agent-flyer-active-print/:printids?"} component={AgentFlyerPrint} />
                <PrivateRoute path={APIPath() + "agent-flyer-print/:printids?"} component={AgentViewFlyerprint} />
                <PrivateRoute path={APIPath() + "agent-my-listing/:listingId?"} component={AgentMylisting} />
                <PrivateRoute path={APIPath() + "agent-flyer-tour/:flyertourid?"} component={AgentFlyerTour} />
                <PrivateRoute path={APIPath() + "agent-video-non-active/:videoId?"} component={AgentVideoNonActive} />
                <Route path={APIPath() + "broker-traffic-report"} component={BrokerTrafficReport} />
                <PrivateRoute path={APIPath() + "agent-panoroma"} component={AgentPanaroma} />
                <Route path={APIPath() + "reset-password/:id?"} component={ResetPassword} />
                <PrivateRoute path={APIPath() + "ezpricingpage"} component={AgentEzPayment} />
                <Route path={APIPath() + "twitterauth/:auth?"} component={TwitterAuth} />
                <Route path={APIPath() + "faq"} component={Faq} />
                <Route path={APIPath() + "blogs"} component={Blog} />
                <Route path={APIPath() + "association-quote"} component={AssociationQuote} />
                <Route path={APIPath() + "appointment"} component={Appointment} />
                <Route path={APIPath() + "example"} component={Example} />
                <Route path={APIPath() + "preferred-vendors"} component={PreferredVendors} />
                <Route path={APIPath() + "association"} component={Associations} />
                <Route path={APIPath() + "agent-register"} component={AgentRegister} />
                ...
                <Route path={APIPath() + "privacy-policy"} component={PrivacyPolicy} />
                ...
                <Route path={APIPath() + "admin-as-agent/:agentId?"} component={AgentAdminLogin} />
                <Route path={APIPath() + "admin-as-broker/:brokerId?"} component={AdminAsBroker} />
                <Route path={APIPath() + "broker-as-agent/:agentId?"} component={BrokerAsAgent} />
                <Route path={APIPath() + "back-to-broker/:brokerId?"} component={BackToBroker} />
