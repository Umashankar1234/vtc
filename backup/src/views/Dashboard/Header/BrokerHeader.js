...
export default function AgentHeader() {
    ...
    useEffect(() => {
        if (context.state.user) {
            const objusr = { authenticate_key: "abcd123XYZ", brokerid: JSON.parse(context.state.user).user_id };
            // postRecord("https://cors-anywhere.herokuapp.com/http://139.59.28.82/vtc/api/get-mycafe", objusr)
            postRecord(APIBrokerDashBoard, objusr)
                .then(res => {
                    if (res.data[0].response.status === "success") {
    ...
    const handleStatusChange = nextChecked => {
        ...
        const objusr = { authenticate_key: "abcd123XYZ", brokerId: JSON.parse(context.state.user).user_id, status: check };
        postRecord(APIBrokerStatusChange, objusr)
            .then(res => {
                if (res.data[0].response.status === "success") {
    ...
    return (
        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-9">
                                        <div class="dash_logo_sec_right">
                                            <ul>
                                                <li><a onClick={() => setOpenModal(true)} style={{ color: "white", cursor: "pointer" }} class="acc_btn"><i class="fas fa-user"></i>Account</a></li>
                                                ...
                                                <li class="dashboard nav-item nav-profile dropdown dropdown-animate show">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown profile-top" aria-labelledby="profileDropdown">
                                                        ...
                                                        <a href={APIPath() + "broker-setting"} class="dropdown-item"><i class="fas fa-cog profile-icon"></i>Account Settings</a>

                                                        <a href={APIPath() + "broker-support"} class="dropdown-item"><i class="fas fa-info-circle profile-icon"></i>Support</a>
            ...
            <Dialog fullWidth={true} onClose={handleClose} aria-labelledby="customized-dialog-title" open={openModal}>
            ...
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={opensubModal}>
                        ...
                        <form
                            ...
                            <div class="row">
                                <div class="col-md-6 formbox1">
                                    ...
                                    <select data-size="5" maxlength="50" class="form-control formbox1select" onChange={handleInputChange} value={subscribeData.countryid} name="countryid">
                                        ...
                                        <option value="40" selected="selected">United States</option>
                                        ...
                                        <option value="221">Falkland Islands (Islas Malvinas)</option>
                                ...
                                <div class="col-md-6 formbox1">
                                    ...
                                    <select class="form-control formbox1select" name="subscriptions" onChange={handleInputChange} value={subscribeData.subscriptions} >
                                        <optgroup label="Monthly Subscriptions">
                                            <option value="39">Platinum [Unlimited Active Tours - $39.99/mo]</option>
                                        </optgroup>
                                        <optgroup label="Yearly Subscriptions">
                                            <option value="399">Platinum [Unlimited Active Tours - $399.00/yr]</option>
                                        </optgroup>
                            ...
                            <div class="row">
                                <div class="col-md-6 formbox1">
                                    ...
                                    <input type="text" class="form-control" name="cc_no" value={subscribeData.subscriptions} readOnly />
                                </div>
                            </div>
                            <div class="row">
