    ...
    function TwitterLoginComponent(props) {
        ...
        _this.initializeProcess = function () {
            if (window.opener) {
                ...
                var _b = _this.props, authCallback_1 = _b.authCallback, consumerKey_1 = _b.consumerKey, consumerSecret_1 = _b.consumerSecret, accessTokenUrl_1 = _b.accessTokenUrl;
        ...
        _this.handleLoginClick = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, consumerKey, consumerSecret, callbackUrl, requestTokenUrl, popup, obtainRequestTokenConfig, requestTokenData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, consumerKey = _a.consumerKey, consumerSecret = _a.consumerSecret, callbackUrl = _a.callbackUrl, requestTokenUrl = _a.requestTokenUrl;
                    ...
                    case 1:
                        ...
                        if ((requestTokenData === null || requestTokenData === void 0 ? void 0 : requestTokenData.oauth_callback_confirmed) === "true" &&
                            popup !== null) {
                            popup.location.href = "https://api.twitter.com/oauth/authorize?oauth_token=" + (requestTokenData === null || requestTokenData === void 0 ? void 0 : requestTokenData.oauth_token);
                            if (popup) {
